...
# Lambda URIs are "{+lambda}/{+function}" e.g. "trailmix/ping".
# We also support path matching at the root e.g. "trailmix" but these require definining separate "_root" terraform resources.
