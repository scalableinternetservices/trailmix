...
git clone https://github.com/rothfels/trailmix.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/trailmix/$SLUG/g" **/*.tf
sed -i.bak "s/trailmix/$SLUG/g" **/*.ts
sed -i.bak "s/trailmix/$SLUG/g" **/*.yml
sed -i.bak "s/trailmix/$SLUG/g" **/*.sh
sed -i.bak "s/trailmix/$SLUG/g" **/*.json
rm -rf **/*.bak
