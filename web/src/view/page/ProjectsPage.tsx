    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/trailmix">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/trailmix#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/trailmix#run-react-storybook',
              },
            ]}
          />
          <Sprint
